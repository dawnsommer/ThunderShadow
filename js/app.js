(() => {
  ...
  function showLibrary() { el.loggerView.hidden = true; el.libraryView.hidden = false; el.loggerTopActions.hidden = true; el.libraryTopActions.hidden = false; el.homeBtn.hidden = true; state.currentForm = null; state.selected.clear(); state.entryRailExpanded = false; setActiveView("library"); renderLibrary(); syncTouchLayout(); document.querySelectorAll("[data-area]").forEach((b) => b.classList.toggle("is-active", b.dataset.area === "logger")); }
