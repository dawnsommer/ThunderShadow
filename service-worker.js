const CACHE_NAME = "thundershadow-github-shell-v25";
const ASSETS = [
  "./",
  "./index.html",
  "./privacy.html",
  "./css/styles.css?v=25",
  "./js/theme-init.js?v=25",
  "./js/uuid.js?v=25",
  "./js/config.js?v=25",
  "./js/reasoning.js?v=25",
  "./js/analytics.js?v=25",
  "./js/browser-api.js?v=25",
  "./js/sync.js?v=25",
  "./js/app.js?v=25",
  "./js/v3.js?v=25",
  "./js/cloud-sync.js?v=25",
  "./manifest.json",
